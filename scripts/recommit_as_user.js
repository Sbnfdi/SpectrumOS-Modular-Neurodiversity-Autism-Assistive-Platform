...
console.log('Resetting branch to create 50 clean commits as Sbnfdi...');
run('git config user.name "Sbnfdi"');
run('git config user.email "abdullahzahid105@gmail.com"');

// Checkout orphan branch to rebuild history cleanly
...
console.log('50 commits created under Sbnfdi (abdullahzahid105@gmail.com)!');
